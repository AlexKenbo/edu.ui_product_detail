...
import 'package:ui_product_detail/widgets/productCircularButton.dart';
import 'package:ui_product_detail/widgets/productColorSelector.dart';
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                  colors: [
                    Color(0xFFdad9d5),
                    Color(0xFFdad9d5).withOpacity(0.2),
                  ],
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ConstrainedBox(
                          ...
                          child: Text('Classic Cotton Jacket',
                              style: TextStyle(
